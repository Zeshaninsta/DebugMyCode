  ...
  return (
    ...
    >
      ...
      <div className=" mx-auto flex flex-col items-center justify-center mb-10 md:h-screen bg-transparent backdrop:blur-md shadow-md border border-slate-700 rounded-lg relative p-2">
        {/* Background */}
        {/* <div className="w-full h-full  z-10 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex justify-center items-center overflow-hidden">
          <code className="text-green-400 text-6xl text-center blur-md opacity-90">
            class DebugMyCode {"{"}
            <br />
